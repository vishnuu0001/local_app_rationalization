    ...
    <div className="portal-app-shell flex h-screen">
      ...
      <div className="portal-content w-64 bg-[linear-gradient(180deg,#081120_0%,#0B1324_42%,#091827_100%)] text-white flex flex-col overflow-hidden shadow-2xl border-r border-slate-800/80">
        ...
        <div className="px-5 pt-5 pb-4 border-b border-slate-800/80 bg-slate-950/50">
          <div className="inline-flex rounded-2xl bg-white p-2 shadow-lg shadow-black/20">
            <img
          ...
          <p className="text-[10px] text-cyan-300/80 mt-3 font-semibold tracking-[0.22em] uppercase">App Rationalization Platform</p>
        ...
        <nav className="flex-1 overflow-y-auto py-3 space-y-0.5 scrollbar-thin">
          ...
          {/* Overview */}
          <div className="px-0">
            <Link to={route('')} className={navItem(isActive(''))}>
      ...
      <div className="portal-content flex-1 flex flex-col overflow-hidden">
        <header className="border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-30">
          <div className="portal-page-width px-5 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
              <p className="text-[11px] uppercase tracking-[0.2em] text-cyan-300">Unified Modernization Suite</p>
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <button
                ...
                className="portal-btn-secondary px-3 py-1.5 rounded-lg"
              >
                Portal Home
              </button>
              {user?.role === 'admin' && (
              ...
              <button
                ...
                className="portal-btn-primary px-3 py-1.5 rounded-lg"
              >
                Logout
              </button>
            </div>
